<template>
    <div class='navContainer' :style="navBackGroundColor">
        ...
        <div class="course-button texiao pointer" @click="$router.push('/m');selectedBlock='a'" :class="{ 'selectedColorMain': selectedBlock=='a'&&colorMode=='main', 'selectedColor': selectedBlock=='a'}" :style="navFontColor">
            新页面
        </div>
        <div class="course-button texiao pointer" @click="$router.push('/zhijiao');selectedBlock='b'" :class="{ 'selectedColorMain': selectedBlock=='b'&&colorMode=='main', 'selectedColor': selectedBlock=='b'}" :style="navFontColor">
            支教页面
        </div>
        <div class="course-button texiao pointer" @click="$router.push('/chooseCourse');selectedBlock='d'" :class="{ 'selectedColorMain': selectedBlock=='d'&&colorMode=='main', 'selectedColor': selectedBlock=='d'}" :style="navFontColor">
            支教页面
        </div>
        <div class="search-input pointer" :style="backgroundS" @click="showSearch=true;showMask=true;$emit('showM');">
        </div>
                <div class="" id="changebyfcz">
       <el-dropdown>
  <span class="el-dropdown-link">
    选择年级<i class="el-icon-arrow-down el-icon--right"></i>
  </span>
  <el-dropdown-menu slot="dropdown">
  <div @click="$router.push('/first');selectedBlock='first'">
            <el-dropdown-item>一年级</el-dropdown-item>
        </div>
     <div @click="$router.push('/second');selectedBlock='second'"><el-dropdown-item>二年级</el-dropdown-item></div>
     <div @click="$router.push('/third');selectedBlock='third'"><el-dropdown-item>三年级</el-dropdown-item></div>
     <div @click="$router.push('/fourth');selectedBlock='fourth'"><el-dropdown-item>四年级</el-dropdown-item></div>
    <div @click="$router.push('/five');selectedBlock='five'"> <el-dropdown-item>五年级</el-dropdown-item></div>
     <div @click="$router.push('/six');selectedBlock='six'"><el-dropdown-item>六年级</el-dropdown-item></div>
  </el-dropdown-menu>
</el-dropdown>
       </div>
...
.search-input{margin-left:195px;
margin-right:15px;
margin-top:28px;
width:23px;
height:23px;
